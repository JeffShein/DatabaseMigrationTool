    ...
    public partial class SchemaViewWindow : Window
    {
        ...
        private void TablesListBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            try
            {
                ...
                if (selectedTable != null)
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        System.Diagnostics.Debug.WriteLine($"Error displaying table details: {ex.Message}");
            ...
            catch (Exception ex)
            {
                ...
                System.Diagnostics.Debug.WriteLine($"Critical error in TablesListBox_SelectionChanged: {ex.Message}");
                System.Windows.MessageBox.Show($"An error occurred while displaying table information. Please try again or select a different table.\n\nError: {ex.Message}", "Table Display Error", System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Warning);
            }
        }
    }
}